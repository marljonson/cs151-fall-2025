...
public class Vendor {
    ...
    public void stockDigicam(double price, String model){
        ...
        Product digiCam = new DigiCam(currId, price, this, model);
    ...
    public void restockById(int vendorProductId, int qty){
        ...
        // if( !(currProduct instanceof Buyable) ) {throw new IllegalStateException("this product is not restockable, create a new product and add it instead!"); }
