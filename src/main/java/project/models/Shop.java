...
public class Shop implements Cloneable {
    ...
    public static int instancesVendor = 0;
    public static int instancesCustomer = 0;
    ...
    private void createVendors(){
        ...
        while(true){ //if more than 100 instances are made, system will display an error without crashing the program (but this is preset, this won't crash or throw)
            try{
                //create Vendors
                Vendor labubuVendor = new Vendor("Labubu Rental Shop", "rentlabubu11@gmail.com");
                instancesVendor++;

                if(instancesVendor > MAXIMUM_INSTANCES) throw new OverHundredObjects("Vendor instances must be less than 100");
            
                Vendor digiCamVendor = new Vendor("Digicam Rental Shop", "rentdigitalcam22@gmail.com"); 
                instancesVendor++;
                ...
                for(int i = 0; i < 50; i++){
                    ...
                    instancesDigicam++;
                    if(instancesDigicam > MAXIMUM_INSTANCES) throw new OverHundredObjects("DigiCam instances must be less than 100");
                }
    ...
    private void createCustomer(){
        try{
            this.currCus = new Customer("guest", "01", "firstCustomer@default.com", 200);
            if(instancesCustomer > MAXIMUM_INSTANCES) throw new OverHundredObjects("Customer instances must be less than 100");
        }catch(OverHundredObjects e){
            System.out.println(e.getMessage());
        }
    }
    ...
    public void handleRole(Scanner sc){
        ...
        switch(roleChoice){
            ...
            case 1 -> {
                Vendor currVendor = validateVendorAndReturnVendor(sc);
    ...
    public Vendor validateVendorAndReturnVendor(Scanner sc){//validate Vendor if "I am a Vendor" is chosen
    ...
    public void handleVendorChoice(Scanner sc, Vendor currVendor){ //NOTE: this is helper method for handleRole()
    ...
    public void helperVendorCase1(Scanner sc, Vendor vendor){
    ...
    public void helperVendorCase3(Scanner sc, Vendor vendor){
    ...
    public void helperVendorCase4(Scanner sc, Vendor vendor){
    ...
    public void helperVendorCase6(Scanner sc, Vendor vendor){
    ...
    public void helperVendorCase7(Scanner sc, Vendor vendor){
    ...
    public void quoteAndRent(Scanner sc, Customer currCus){
        ...
        while(true){
            try{
                ...
                if(!(p instanceof Rentable)){ throw new IllegalStateException("Product is not rentable"); }

                Instant quotedAt = Instant.now();
                double quotedPrice = ((Rentable)p).quoteRental(quotedAt); //basically Instant.now()
    ...
    public void helperCustomerCase5(Scanner sc, Customer currCus){
        ...
        while(true){
            ...
            try{
                ...
                String key = Customer.makeKey(currVendor.getVendorId(), vendorProductId);
    ...
    public void helperCustomerCase6(Scanner sc, Customer currCus){
    ...
    public List<Vendor> getVendorsList(){ return vendorsList; }
